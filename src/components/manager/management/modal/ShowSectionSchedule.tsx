...
import type { ScheduleSectionResponse, Section } from '../../../../type/manager.type'
...
type ScheduleViewerProps = {
    ...
    onClose: () => void;
    section: Section;
    schedule: ScheduleSectionResponse | null;
    isLoading: boolean;
};

export const ShowSectionSchedule = ({
    isOpen,
    onClose,
    section,
    schedule,
    ...
    const imageUrl = schedule?.imageUrl ? getImageUrl(schedule.imageUrl) : null;
                ...
                <div className="flex items-center justify-between p-6 border-b border-blue-gray-100">
                    <div>
                        ...
                        <p className="text-sm text-blue-gray-500">
                            {section.name} - {section.gradeName || `Grade ${section.localGradeNumber}`}
                        </p>
                    </div>
                    <button
                        onClick={onClose}
                    ...
                    {isLoading ? (
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-xs text-blue-gray-400 mt-1">
                                Uploaded: {formatDate(schedule?.createdAt || new Date().toISOString())}
                            </p>
                        </div>
                    ) : (
                        <div className="flex flex-col items-center justify-center h-64 text-center">
                            ...
                            <p className="text-sm text-blue-gray-600">
                                No schedule image has been uploaded for this section yet.
                            </p>
...
export default ShowSectionSchedule;