  ...
  return (
    <header className="bg-white border-b border-blue-gray-100 px-4 lg:px-6 xl:px-8 py-4">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold text-dark-blue-800">Admin Dashboard</h2>
          <p className="text-sm text-blue-gray-500">Welcome back, {user?.name || 'Admin'}!</p>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="sm:mr-15 lg:mr-0 xl:mr-0 flex items-center gap-3 px-3 py-2 hover:bg-blue-gray-50 rounded-xl transition-colors">
            ...
            <div className="hidden lg:block text-left">
              <p className="text-sm font-semibold text-dark-blue-800">{user?.name || 'Admin'}</p>
              <p className="text-xs text-blue-gray-500">{user?.role || 'Administrator'}</p>
            </div>
          </div>
        </div>
      </div>
